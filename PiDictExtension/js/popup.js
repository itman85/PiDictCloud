...
try  {
  ...
  curMouseX=drLeft>0?drLeft:1;
  curMouseY=drTop>0?drTop:1;
}
...
/////////Div behavior/////////
function divDbclick(divObj)
{
	var text = divObj.innerHTML;
	divObj.innerHTML = "<span><textarea name=newname onscroll=\"srolling()\" rows=\"5\" cols=\"25\" >" + text + "</textarea> </span>"
	//alert(html);
}
