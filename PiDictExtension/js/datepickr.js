...
var datepickr = (function() {
    ...
    function buildDays(firstOfMonth, numDays, currentMonthView, currentYearView) {
        ...
        for(i = 1; i <= firstOfMonth; i++) {
            row.appendChild(buildNode('td', { className: 'empty' }, ''));
            dayCount++;
        }
    ...
    function buildCalendar() {
        ...
        //50 is height of bottom bar
        calendarContainer.style.cssText = 'display: none; bottom:' + (50-document.body.scrollTop) + 'px; left: ' + inputLeft + 'px;';
    ...
    return function(elementId, userConfig) {
        ...
        this.open = function(e) {
            ...
            self.calendar.style.bottom = (50-document.body.scrollTop) + 'px';//update position with the current scrollTop
        }
